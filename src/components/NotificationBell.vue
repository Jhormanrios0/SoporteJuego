<template>
	<div class="notification-bell-wrapper">
		<button
			...
			<img src="/icons/icon_bell.webp" alt="Notificaciones" class="bell-icon" :class="{ ringing: unreadCount > 0 }" />
		...
		<Transition name="panel-slide">
			<div v-if="isOpen" class="notification-panel" @click.stop>
				<div class="panel-header">
					...
					<button v-if="notifications.length > 0" class="mark-all-read" @click="markAllAsRead">Marcar todo leído</button>
				</div>
				...
				<div class="panel-content">
					...
					<TransitionGroup v-else name="notification-list" tag="div" class="notifications-list">
						<div
							...
							<div class="notification-icon">
								...
								<HelpCircle v-else-if="notification.type === 'help'" :size="18" />
							...
							<div class="notification-content">
								...
								<div
									...
									:style="{
										'--status-color': notification.senderStatus.color || '#8b7355',
							...
							<div class="notification-actions">
								...
								<button class="notification-dismiss" @click.stop="dismissNotification(notification.id)" aria-label="Descartar" title="Eliminar">
									<X :size="14" />
								</button>
							</div>
						</div>
...
<script setup>
	...
	import { Bell, BellOff, AtSign, HelpCircle, MessageCircle, X, Trash2, Check, History } from 'lucide-vue-next';
	...
	const emit = defineEmits(['toggle', 'mark-read', 'mark-all-read', 'dismiss', 'clear-all', 'notification-click', 'open-history']);
...
<style scoped>
	...
	.notification-bell-btn {
		...
		box-shadow:
			inset 2px 2px 0 #a67c52,
			inset -2px -2px 0 #3d2610,
			4px 4px 0 #1a1208,
	...
	@keyframes minecraftGlow {
		...
		100% {
			box-shadow:
				inset 2px 2px 0 #ffcc55,
				inset -2px -2px 0 #aa5500,
				4px 4px 0 #1a1208,
	...
	.notification-panel {
		...
		border-radius: 0;
		box-shadow:
			inset 0 0 0 2px #5c3d1e,
			inset 0 0 0 4px #3d2610,
			6px 6px 0 #1a1208,
	...
	.mark-all-read {
		...
		box-shadow:
			inset 1px 1px 0 #77cc77,
			inset -1px -1px 0 #225522;
	}
	...
	.history-btn {
		...
		box-shadow:
			inset 1px 1px 0 #5588bb,
			inset -1px -1px 0 #112244;
	}
	...
	.clear-all-btn {
		...
		box-shadow:
			inset 1px 1px 0 #cc5555,
			inset -1px -1px 0 #551111;
	}
